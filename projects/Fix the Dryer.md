Dryer will not turn on and is not indicating any power being supplied to it.


- turn the dryer cycle knob to the OFF position, and unplug it from the wall


# Main issues that cause dryer not to start
- Power Supply
	- Ensure dryer is plugged in properly and circuit breaker is intact.
	- If your dryer won't start, the first thing to check is that the circuit breaker hasn't been tripped.
- Faulty Door Switch
