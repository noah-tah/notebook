...
- The management of Merlinos Mills wants each department to upgrade to newer OSs. Also, they are very concerned about network security, and they want to install new servers and upgrade their current servers to OS versions that take better advantage of security features. Your role in the process is to work with each department to help ensure th
